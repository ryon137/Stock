...
public class StockController {
    ...
    public ResponseEntity<Double> getStock(@PathVariable ObjectId companyCode, @PathVariable LocalDateTime startDate, @PathVariable LocalDateTime endDate) {
        //for a given company,
        // returns list of stock price that reside within the start and end date
        List<Double> stockPrice = stockService.getCompanyStockPrice(startDate, endDate, companyCode);
    ...
    public ResponseEntity<Double> getStockPriceBreakDown(@PathVariable ObjectId companyCode, @PathVariable LocalDateTime startDate, @PathVariable LocalDateTime endDate){
        List<Double> breakDown = stockService.companyStockMaxMinAvg(startDate,endDate,companyCode);
